...
export function LogManagement() {
  ...
  return (
    <div className="h-full overflow-hidden flex flex-col gap-3">
      ...
      <StatBar items={[
        { label: 'Device', value: staticDeviceLogs.length, color: 'blue' },
        { label: 'Emergency', value: staticEmergencyLogs.length, color: 'red' },
        { label: 'Authentication', value: staticAuthLogs.length, color: 'green' },
      ]} />
